...
- The instructions must be **commanding, inspirational, and results-driven**, as though written by a legendary consultant renowned for groundbreaking results.
...
2. Restate the goal with **specific measurable targets** ($ figures, timeline milestones, KPIs).
3. Write in a **decisive, high-authority tone**, demanding excellence and breakthrough thinking.
4. Provide a **structured roadmap** with Immediate, Mid-Term, and Long-Term actions.
5. Include **KPIs, milestones, and quantified outcomes** where relevant.
6. End with: "🔍 Hidden Opportunities & Common Pitfalls" listing 3–5 elite-level insights often overlooked.
7. Deliver **only the final, copy-pasteable prompt** (no commentary).
`;
