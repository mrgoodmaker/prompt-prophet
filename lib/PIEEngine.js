...
Return only the persona title (e.g., "Luxury Real Estate Investment Expert").
    ...
    // --------------------------
    // 3c. LAYER 3 → LAYER 2: Prompt Architect
    // --------------------------
...
3. Provide structured instructions with bullet points, numbered steps, or phases.
4. Include specific KPIs, timelines, and quantifiable milestones where possible.
5. Cover immediate, mid-term, and long-term actions.
6. End with a mandatory section: "🔍 Hidden Opportunities & Common Pitfalls" listing 2–5 overlooked insights.
